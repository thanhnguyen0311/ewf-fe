...
import {CellClassParams, CellValueChangedEvent, ColDef} from 'ag-grid-community';
import Loader from "../../UiElements/Loader/Loader";

import "./style.css";
import {mapComponentPropToRequest} from "../../../utils/mapFunctions";
import {getComponentsInventory, updateComponent} from "../../../api/apiService";
import ImageModal from "../../UiElements/Modals";
import {CellChangedEvent, CheckboxChangedEvent, ICellRendererParams} from "ag-grid-enterprise";
...
const CInventory: FC = () => {
    ...
    const handleCheckboxChange = async (params: ICellRendererParams) => {
    ...
    const fetchComponents = async () => {
        try {
            setLoading(true);
            const sortedComponents = await getComponentsInventory();
